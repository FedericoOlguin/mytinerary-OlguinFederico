...
const Itinerary = [
    {
        ciudad: "621ea3b71c69f08fe790d6f3",
        user: {
            nombre: "Facundo",
            foto: "FacundoUser.jpg"
        },
        tituloIt: "Bamboo Forest",
        price: 4,
        duration: 3.30,
        likes: 0,
        tags: ["#kyoto", "#bambooForest", "#zenLife", "#japan"],
        comments: [],
        activities: []
    },
    {
        ...
        user: {
            nombre: "Jorgelina",
            foto: "JorgelinaUser.jpg"
        },
        tituloIt: "Kyoto Kifune Shrine",
        price: 2,
        duration: 3,
        likes: 0,
        tags: ["#sanctuary", "#godOfWater", "#meditation", "#japan"],
        comments: [],
        activities: []
    },
    {
        ciudad: "621ea3b71c69f08fe790d6f4",
        user: {
            nombre: "Mariano",
            foto: "MarianoUser.jpg"
        },
        tituloIt: "Dubrovnik walls",
        price: 2,
        duration: 2.30,
        likes: 0,
        tags: ["#dubrovnik", "#croatia", "#exploreCroatia", "#wallsofdubrovnik"],
        comments: [],
        activities: []
    },
    {
        ...
        user: {
            nombre: "Julieta",
            foto: "JulietaUser.jpg"
        },
        tituloIt: "",
        price: 0,
        duration: 0,
        likes: 0,
        tags: ["#sponzapalace", "#croatiatravel", "#monument", "#croatiafulloflife"],
        comments: [],
        activities: []
    }
]
